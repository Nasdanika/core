	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (this,
		   source,
		   new String[] {
			   "documentation", "Base classes for graph-like models such as process/flow and architecture models"
		   });
		addAnnotation
		  (graphElementEClass,
		   source,
		   new String[] {
			   "documentation", "Graph element uniquely identified in the containing graph by a string identifier. This allows to implement graph inheritance - deriving a graph from another graph by removing, adding and replacing graph elements similar to how inheritance works in object-oriented languages."
		   });
		addAnnotation
		  (graphEClass,
		   source,
		   new String[] {
			   "documentation", "Graph is a container of graph elements uniquely identified by a string identifier. This allows to implement graph inheritance - deriving a graph from another graph by removing, adding and replacing graph elements similar to how inheritance works in object-oriented languages."
		   });
		addAnnotation
		  (getGraph_Elements(),
		   source,
		   new String[] {
			   "documentation", "Graph elements uniquely identified by a string identifier. This allows to implement graph inheritance - deriving a graph from another graph by removing, adding and replacing graph elements similar to how inheritance works in object-oriented languages."
		   });
		addAnnotation
		  (subGraphEClass,
		   source,
		   new String[] {
			   "documentation", "A graph element which is also a graph, i.e. it may contain other graph elements. "
		   });
		addAnnotation
		  (connectionTargetEClass,
		   source,
		   new String[] {
			   "documentation", "A graph element which can have incoming connections"
		   });
		addAnnotation
		  (getConnectionTarget_IncomingConnections(),
		   source,
		   new String[] {
			   "documentation", "Incoming connections"
		   });
		addAnnotation
		  (compositeConnectionTargetEClass,
		   source,
		   new String[] {
			   "documentation", "Connection target which is also as sub-graph, i.e. it may contain other graph elements"
		   });
		addAnnotation
		  (connectionEClass,
		   source,
		   new String[] {
			   "documentation", "Connections are contained by their source and uniquiely identified in the source by a string id. This allows to implement connection inheritance behaviors such as overriding (replacing), adding, or removing."
		   });
		addAnnotation
		...
		addAnnotation
		  (getConnection_Bidirectional(),
		   source,
		   new String[] {
			   "documentation", "Indicates that the connection is bidirectional"
		   });
		addAnnotation
		  (connectionSourceEClass,
		   source,
		   new String[] {
			   "documentation", "Source of connections uniquely identified by string ids. It provides support for graph inheritance - replacing (overriding), adding, or removing connections"
		   });
		addAnnotation
		  (getConnectionSource_OutgoingConnections(),
		   source,
		   new String[] {
			   "documentation", "Outgoing connections uniquely identified by a string to support graph inheritance"
		   });
		addAnnotation
		  (compositeConnectionSourceEClass,
		   source,
		   new String[] {
			   "documentation", "Connection source which is also a sub-graph. I.e. it may contain other graph elements."
		   });
		addAnnotation
		  (nodeEClass,
		   source,
		   new String[] {
			   "documentation", "Node is both connection source and target. I.e. it may have both incoming and outgoing connections."
		   });
		addAnnotation
		  (compositeNodeEClass,
		   source,
		   new String[] {
			   "documentation", "Node which is also a sub-graph. I.e. it may contain other graph elements."
		   });
		addAnnotation
		  (tunnelEClass,
		   source,
		   new String[] {
			   "documentation", "Tunnel is a connection which logically groups other connections. For example, two composite nodes may have a tunnel connection which groups connections between their child elements. A real life example is a VPN tunnel between two networks."
		   });
		addAnnotation
		  (getTunnel_Connections(),
		   source,
		   new String[] {
			   "documentation", "Connections in this tunnel"
		   });
		addAnnotation
		  (documentedNamedGraphElementEClass,
		   source,
		   new String[] {
			   "documentation", "Graph element with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedGraphEClass,
		   source,
		   new String[] {
			   "documentation", "Graph with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedSubGraphEClass,
		   source,
		   new String[] {
			   "documentation", "Sub-graph element with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedConnectionTargetEClass,
		   source,
		   new String[] {
			   "documentation", "Connection target with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedCompositeConnectionTargetEClass,
		   source,
		   new String[] {
			   "documentation", "Composite connection target with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedConnectionEClass,
		   source,
		   new String[] {
			   "documentation", "Connection with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedConnectionSourceEClass,
		   source,
		   new String[] {
			   "documentation", "Connection source with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedCompositeConnectionSourceEClass,
		   source,
		   new String[] {
			   "documentation", "Composite connection source with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedNodeEClass,
		   source,
		   new String[] {
			   "documentation", "Node with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedCompositeNodeEClass,
		   source,
		   new String[] {
			   "documentation", "Composite node with a name and documentation"
		   });
		addAnnotation
		  (documentedNamedTunnelEClass,
		   source,
		   new String[] {
