...
public class TreeFactoryImpl extends EFactoryImpl implements TreeFactory {
	...
	public EObject create(EClass eClass) {
		...
		case TreePackage.ADAPTER_FACTORY_TREE:
			return createAdapterFactoryTree();
		case TreePackage.ADAPTER_FACTORY_TREE_DESCRIPTION:
			return createAdapterFactoryTreeDescription();
		default:
	 ...
	 * @generated
	 */
	public AdapterFactoryTree createAdapterFactoryTree() {
		AdapterFactoryTreeImpl adapterFactoryTree = new AdapterFactoryTreeImpl();
		return adapterFactoryTree;
	}
	 ...
	 * @generated
	 */
	public AdapterFactoryTreeDescription createAdapterFactoryTreeDescription() {
		AdapterFactoryTreeDescriptionImpl adapterFactoryTreeDescription = new AdapterFactoryTreeDescriptionImpl();
		return adapterFactoryTreeDescription;
	}
