...
/**
 * This is the item provider adapter for a {@link org.nasdanika.engineering.Objective} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectiveItemProvider 
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Objective_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Objective_parent_feature", "_UI_Objective_type"),
				 EngineeringPackage.Literals.OBJECTIVE__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EngineeringPackage.Literals.OBJECTIVE__CHILDREN);
			childrenFeatures.add(EngineeringPackage.Literals.OBJECTIVE__KEY_RESULTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EngineeringPackage.Literals.OBJECTIVE__CHILDREN,
				 EngineeringFactory.eINSTANCE.createObjective()));

		newChildDescriptors.add
			(createChildParameter
				(EngineeringPackage.Literals.OBJECTIVE__KEY_RESULTS,
				 EngineeringFactory.eINSTANCE.createKeyResult()));
	}
