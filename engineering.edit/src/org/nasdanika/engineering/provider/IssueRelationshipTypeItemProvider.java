...
/**
 * This is the item provider adapter for a {@link org.nasdanika.engineering.IssueRelationshipType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IssueRelationshipTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IssueRelationshipType_blocks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IssueRelationshipType_blocks_feature", "_UI_IssueRelationshipType_type"),
				 EngineeringPackage.Literals.ISSUE_RELATIONSHIP_TYPE__BLOCKS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		IssueRelationshipType issueRelationshipType = (IssueRelationshipType)object;
		return getString("_UI_IssueRelationshipType_type") + " " + issueRelationshipType.isBlocks();
	}
