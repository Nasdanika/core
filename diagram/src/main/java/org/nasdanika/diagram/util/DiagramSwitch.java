 ...
 * <!-- end-user-doc -->
 * @see org.nasdanika.diagram.DiagramPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DiagramPackage.LAYER: {
				...
				if (result == null) result = caseAdaptable(layer);
			...
			case DiagramPackage.DIAGRAM: {
				...
				if (result == null) result = caseLayer(diagram);
				...
				if (result == null) result = caseAdaptable(diagram);
				if (result == null) result = caseIMarked(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramPackage.CONNECTION: {
				...
				if (result == null) result = caseStyle(connection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramPackage.START: {
				...
				if (result == null) result = caseStyle(start);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramPackage.END: {
				...
				if (result == null) result = caseStyle(end);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
