...
public class ResourcesFactoryImpl extends EFactoryImpl implements ResourcesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ResourcesPackage.CONTAINER: return createContainer();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ResourcesPackage.RECONCILE_ACTION:
	 ...
	 */
	@Override
	public org.nasdanika.exec.resources.Container createContainer() {
