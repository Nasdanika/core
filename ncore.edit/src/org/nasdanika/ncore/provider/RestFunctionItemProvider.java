...
/**
 * This is the item provider adapter for a {@link org.nasdanika.ncore.RestFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RestFunctionItemProvider extends RestOperationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RestFunctionItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RestFunction"));
	}
	...
	public String getText(Object object) {
		String label = ((RestFunction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RestFunction_type") :
			getString("_UI_RestFunction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RestFunction.class)) {
