 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.ncore.impl.BooleanImpl#getMarkers <em>Markers</em>}</li>
...
public class BooleanImpl extends MinimalEObjectImpl.Container implements org.nasdanika.ncore.Boolean {
	...
	public EList<Marker> getMarkers() {
		return (EList<Marker>)eDynamicGet(NcorePackage.BOOLEAN__MARKERS, NcorePackage.Literals.MARKED__MARKERS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NcorePackage.BOOLEAN__MARKERS:
