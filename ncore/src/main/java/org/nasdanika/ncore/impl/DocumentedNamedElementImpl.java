 ...
 * @generated
 */
public class DocumentedNamedElementImpl extends NamedElementImpl implements DocumentedNamedElement {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return NcorePackage.Literals.DOCUMENTED_NAMED_ELEMENT;
	}
	...
	public EList<EObject> getDocumentation() {
		return (EList<EObject>)eDynamicGet(NcorePackage.DOCUMENTED_NAMED_ELEMENT__DOCUMENTATION, NcorePackage.Literals.DOCUMENTED__DOCUMENTATION, true, true);
	}
