 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.ncore.impl.TreeImpl#getTreeItems <em>Tree Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TreeImpl extends TreeItemImpl implements Tree {
	...
	protected EClass eStaticClass() {
		return NcorePackage.Literals.TREE;
	}
	...
	public EList<TreeItem> getTreeItems() {
		return (EList<TreeItem>)eDynamicGet(NcorePackage.TREE__TREE_ITEMS, NcorePackage.Literals.TREE__TREE_ITEMS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NcorePackage.TREE__TREE_ITEMS:
