 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.ncore.impl.DoubleImpl#getMarkers <em>Markers</em>}</li>
 *   <li>{@link org.nasdanika.ncore.impl.DoubleImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleImpl extends MinimalEObjectImpl.Container implements org.nasdanika.ncore.Double {
	...
	protected EClass eStaticClass() {
		return NcorePackage.Literals.DOUBLE;
	}
	...
	public EList<Marker> getMarkers() {
		return (EList<Marker>)eDynamicGet(NcorePackage.DOUBLE__MARKERS, NcorePackage.Literals.MARKED__MARKERS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NcorePackage.DOUBLE__MARKERS:
