...
/**
 * This is the item provider adapter for a {@link org.nasdanika.party.MarkdownResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MarkdownResourceItemProvider extends MarkdownItemProvider {
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor(
				 ...
				 PartyPackage.Literals.MARKDOWN_RESOURCE__LOCATION,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MarkdownResource"));
	}
	...
	public String getText(Object object) {
		String label = ((MarkdownResource)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MarkdownResource_type") :
			getString("_UI_MarkdownResource_type") + " " + label;
	}
