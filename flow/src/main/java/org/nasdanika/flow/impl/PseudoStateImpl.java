 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.flow.impl.PseudoStateImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PseudoStateImpl extends FlowElementImpl<PseudoState> implements PseudoState {
	...
	public String getType() {
		return (String)eDynamicGet(FlowPackage.PSEUDO_STATE__TYPE, FlowPackage.Literals.PSEUDO_STATE__TYPE, true, true);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowPackage.PSEUDO_STATE__TYPE:
				return getType();
		}
