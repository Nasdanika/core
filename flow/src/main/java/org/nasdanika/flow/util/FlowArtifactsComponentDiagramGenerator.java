...
public class FlowArtifactsComponentDiagramGenerator {
	
	DiagramFactory diagramFactory = DiagramFactory.eINSTANCE;

	public Diagram generateArtifactComponentDiagram(Artifact artifact) {
		Diagram ret = createDiagram(artifact);
	...
	protected Diagram createDiagram(Artifact artifact) {
