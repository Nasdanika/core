 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.party.impl.RoleImpl#getParties <em>Parties</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RoleImpl extends NamedElementImpl implements Role {
	...
	public EList<Party> getParties() {
		return (EList<Party>)eDynamicGet(PartyPackage.ROLE__PARTIES, PartyPackage.Literals.ROLE__PARTIES, true, true);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PartyPackage.ROLE__PARTIES:
				return getParties();
		}
