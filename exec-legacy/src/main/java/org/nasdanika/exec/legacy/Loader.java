...
import org.nasdanika.exec.legacy.content.Base64;
import org.nasdanika.exec.legacy.content.Form;
import org.nasdanika.exec.legacy.content.FreeMarker;
import org.nasdanika.exec.legacy.content.HttpCall;
import org.nasdanika.exec.legacy.content.Interpolator;
import org.nasdanika.exec.legacy.content.Json;
import org.nasdanika.exec.legacy.content.Markdown;
import org.nasdanika.exec.legacy.content.Mustache;
import org.nasdanika.exec.legacy.content.Replace;
import org.nasdanika.exec.legacy.content.Resource;
import org.nasdanika.exec.legacy.content.ScriptEvaluator;
import org.nasdanika.exec.legacy.content.Yaml;
import org.nasdanika.exec.legacy.content.ZipArchive;
import org.nasdanika.exec.legacy.java.Annotation;
import org.nasdanika.exec.legacy.java.CompilationUnit;
import org.nasdanika.exec.legacy.java.Constructor;
import org.nasdanika.exec.legacy.java.Field;
import org.nasdanika.exec.legacy.java.Interface;
import org.nasdanika.exec.legacy.java.Method;
import org.nasdanika.exec.legacy.java.SourceFolder;
import org.nasdanika.exec.legacy.java.TypeAdapter;
import org.nasdanika.exec.legacy.resources.Container;
import org.nasdanika.exec.legacy.resources.File;
import org.nasdanika.exec.legacy.resources.Git;
import org.nasdanika.exec.legacy.resources.ZipResourceCollection;
...
public class Loader implements ObjectLoader {
	...
	public Object create(ObjectLoader loader, String type, Object config, URL base, ProgressMonitor progressMonitor, Marker marker) throws Exception {
		...
		try (ProgressMonitor subMonitor = progressMonitor.setWorkRemaining(10).split("Creating " + type, 1, marker)) {
			...
			case "(map)":
				return new org.nasdanika.exec.legacy.Map(loader, config, base, subMonitor, marker).getMap();
			...
			case "package": 
				return new org.nasdanika.exec.legacy.java.Package(loader, config, base, subMonitor, marker);
			...
			case "class": 
				return new TypeAdapter(new org.nasdanika.exec.legacy.java.Class(loader, config, base, subMonitor, marker));
			case "enum": 
				return new TypeAdapter(new org.nasdanika.exec.legacy.java.Enum(loader, config, base, subMonitor, marker));
			case "interface": 
