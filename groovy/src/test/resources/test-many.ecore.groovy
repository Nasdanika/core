	...
	ePackage {
		...
		eAnnotation {
			...
			details {
				...
				key "documentation"
				value '''
					This is a test Ecore model with multiple packages, classes, and references. 
					It demonstrates the use of global URIs for EClasses and EPackages, as well as the use of both string and closure selectors for resolving EReferences.
					The model includes a Person class, and Address class.
				'''.stripIndent().trim()
		...
		eClass {
			...
			eAttribute {
				...
				name "street"
				eType "EString" // loaded from EPackage classifiers. In case of name collision with local definitions use ./<name> to disambiguate
