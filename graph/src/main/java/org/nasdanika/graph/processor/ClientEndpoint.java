...
/**
 * Field or method to inject a matching client endpoint. A method shall have one, two or three parameters. 
 * If a single parameter than the endpoint is passed to the method. If two parameters then the client key and endpoint are passed - it allows to use one method for more than one client/endpoint.   
